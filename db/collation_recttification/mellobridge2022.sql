...
CREATE TABLE `mb_modules` (
  ...
  `module_description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('A','I','D') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'A-active, I-Inactive, D-Delete',
  `is_deleted` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Y-yes, N-no',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` bigint NOT NULL,
...
CREATE TABLE `mb_module_functionalities` (
  ...
  `function_description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `mb_roles` (
  `id` bigint NOT NULL,
  `role_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `role_description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `mb_users` (
  ...
  `phone` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `role_id` bigint UNSIGNED DEFAULT NULL,
  `userkey` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `usertype` enum('S','SA','FU') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'S=Superadmin SA=SubAdmin FU=Frontend User',
  `company_name` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `status` enum('A','I','D') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'A-active, I-Inactive, D-Delete',
  `is_reset` enum('Y','N') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `setting_json` longtext CHARACTER SET utf8 COLLATE utf8_bin,
  `remember_token` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_from` enum('B','F') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'B= Backend , F = Frontednd',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
