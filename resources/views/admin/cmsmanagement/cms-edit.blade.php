                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('admin.cms-management.edit',[$encryptCode])}}" method="POST"  id="cms_edit">
                                    {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-10">
                                            ...
                                            <label  class="col-sm-2 col-form-label">Name : <span class="error">*</span></label>
                                                <div class="col-sm-10">
                                                <input type="text" name="name" id="name" readonly value="{{$details->name}}" class="form-control" placeholder=" Name" title="Name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Description : </label>
                                                ...
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$details->description}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label">Slug : <span class="error">*</span></label>
                                                    <div class="col-sm-10">
                                                    <input type="text" name="slug" id="slug" readonly value="{{$details->slug}}" class="form-control" placeholder=" Slug" title="Slug">
                                                    </div>
                                            </div>
