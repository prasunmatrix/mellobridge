    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Setting Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                        ...
                                        @endif
                                <table class="table table table-bordered table-striped" id="insurance_price-table">
                                    <thead>
                                    <tr>
        ...
        @push('custom-scripts')
           ...
           <script>
               $(document).ready(function () {
                   oTable = $('#insurance_price-table').DataTable({
                       processing: true,
                       serverSide: true,
                        pageLength: 50,
                       ajax: {
                           url: '{!! route("admin.insurance-price.list.table") !!}',
                           data: function (d) {
                               d.type = $('select[name=type]').val();
                           }
                       },
                       columns: [
                        {data: 'insurance_price', name: 'insurance_price'},
                        {data: 'lable_price', name: 'lable_price'},
