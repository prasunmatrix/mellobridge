    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Shipment  Tracking List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Shipment  Tracking List</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table table-bordered table-striped" id="shipment-track-table">
                                    <thead>
                                    <tr>
        ...
        @push('custom-scripts')
           ...
           <script>
               $(document).ready(function () {
                   ...
                   oTable = $('#shipment-track-table').DataTable({
                       processing: true,
                       serverSide: true,
                        pageLength: 50,
                       ajax: {
                           url: '{!! route("admin.shipment-track.list.table") !!}',
                        //    data: {'status' : status},
                        data: function (d) {
                               d.status =$('#status').val();
                           }
