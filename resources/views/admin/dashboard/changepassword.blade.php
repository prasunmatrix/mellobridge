                        ...
                        <div class="card-body">
                                ...
                                <form class="form-horizontal" method="POST" action="{{route('admin.changePassword')}}" id="change_password">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a class="btn btn-primary back_new" href="{{route('admin.'.\App::getLocale().'.dashboard')}}">Back</a>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="form-group row{{ $errors->has('current_password') ? ' has-error' : '' }}">
                                                            <label for="new-password" class="col-sm-2 col-form-label">Current Password: <span class="error">*</span></label>
                                                        ...
                                                        <div class="form-group row{{ $errors->has('new_password') ? ' has-error' : '' }}">
                                                            <label for="new-password" class="col-sm-2 col-form-labe">New Password: <span class="error">*</span> </label>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="new-password-confirm" class="col-sm-2 col-form-labe">Confirm New Password: <span class="error">*</span></label>
