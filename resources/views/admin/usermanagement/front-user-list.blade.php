                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                ...
                                <div class="card-header">
                                    ...
                                    @if(checkFunctionPermission('user-management.front-user.add'))
                                    <a href="{{route('admin.user-management.front-user.add')}}"
                                                class="btn btn-success btn-xs">User
                                                                                    Create</a>
                                    @endif                                              
                                    </h3>
                                </div>
           ...
           <script>
               $(document).ready(function () {
                   oTable = $('#user-table').DataTable({
                       ...
                       serverSide: true,
                       ajax: {
                           url: '{!! route("admin.user-management.front-user.list.table") !!}',
                           data: function (d) {
                       ...
                       columns: [
                           ...
                           {data:'role_data.role_name', name:'role_name'},
