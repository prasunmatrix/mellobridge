                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                 @if(count($errors) > 0)
                                        ...
                                        @endif                          
                                <form action="{{route('admin.coupon-add')}}" method="POST"  id="Create_User">
                                        {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-10">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="amount" id="amount" value="{{old('amount')}}"class="form-control" placeholder="Discount Amount" title="Email">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <label for="Title" class="col-sm-2 col-form-label">Valid From : <span class="error">*</span></label>
                                                       <div class="col-sm-10">
                                                        <input type="text" name="valid_from" id="valid_from" value="{{old('valid_from')}}"class="form-control" placeholder="Valid From" title="Phone">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    <label for="Title" class="col-sm-2 col-form-label">Valid Upto : <span class="error">*</span></label>
                                                       <div class="col-sm-10">
                                                        <input type="text" name="valid_upto" id="valid_upto" value="{{old('valid_upto')}}"class="form-control" placeholder="Valid Upto" title="Phone">
                                                        </div>
