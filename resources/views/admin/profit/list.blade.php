    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Profit Margin Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Profit Margin List</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
               ...
               $(document).ready(function () {
                   oTable = $('#coupon-table').DataTable({
                       ...
                       serverSide: true,
                        pageLength: 50,
                       ajax: {
                           url: '{!! route("admin.profit.list.table") !!}',
                           data: function (d) {
                               d.type = $('select[name=type]').val();
                           }
                       },
                       columns: [
                        {data: 'start_weight', name: 'start_weight'},
                        {data: 'end_weight', name: 'end_weight'},
                        {data: 'unit', name: 'unit'},
