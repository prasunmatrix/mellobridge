        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.notification.list')}}">Notification List</a></li>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.notification-editSubmit',[$encryptCode])}}" method="POST"  id="user_edit">
                                    {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="Title" class="col-sm-2 col-form-label">Message : <span class="error">*</span></label>
                                            <div class="col-sm-10">
                                            <textarea id="message" name="message" rows="4" cols="50">{{$details->message}}</textarea>
                                            </div>
                                        </div>
