         ...
         <div class="setting-area account">
            ...
            <div class="row">
               ...
               @if(count($errors) > 0)
                                        ...
                                        @endif
               <form method="post" action="{{ route('profilesubmit') }}" id="profile" name="profile">
                {{ csrf_field() }}
                  <div class="row">
                     <div class="col col-50">
                        <h2>Name</h2>
                        <div class="sipinput">
                        <input type="text" name="name" value="{{$userData->name}}" required id="name"/>
                     </div>
                     </div>
                     <div class="col col-50">
                        <h2>Email</h2>
                        <div class="sipinput">
                        <input type="email" name="email" value="{{$userData->email}}" required id="email"/>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col col-50">
                        <h2>Phone</h2>
                        <div class="sipinput">
                        <input type="text" name="phone" value="{{$userData->phone}}" required id="phone"/>
                     </div>
                     </div>
                     {{--<div class="col col-50">
