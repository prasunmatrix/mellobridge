  ...
  <section class="page-breadcrumb">
    <div class="container">
      <ul>
        ...
        <li><a>Latest Press Release</a></li>
      </ul>
    </div>
  </section>
...
<script>
    ...
    export default {
        ...
        mounted(){
          ...
          if(this.$route.name == "category-press-release"){
            this.category= this.$route.params.categoryId;
            this.getLatestPressrelese('',1,this.category);
          } else {
            this.getLatestPressrelese('',1,'');
          }
        ...
        methods:{
          ...
          getNextpage(){
              this.getLatestPressrelese(this.searchKeyword,this.pageNo,this.category);
          },
          ...
          searchByKeywords(){
            ...
            this.getLatestPressrelese(this.searchKeyword,1,this.category);
          },
          ...
          handleChange(e) {
              if(e.target.options.selectedIndex > -1) {
                ...
                let categoryId = e.target.options[e.target.options.selectedIndex].value;
                  ...
                  //console.log(cat_id);
                  this.pressReleaseData=[];
                  this.getLatestPressrelese('',1,categoryId);
              }
          },
          ...
          getLatestPressrelese(searchKeyword,pageNo,category){
            apiService.hitLatestPressreleaseApi(searchKeyword,pageNo,category)
                    .then(res => {
                      if(res.has_error == 0 ){
